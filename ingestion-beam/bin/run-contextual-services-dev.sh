...
$SCRIPT_DIR/mvn compile exec:java -Dexec.mainClass=com.mozilla.telemetry.ContextualServicesReporter -e -Dexec.args="\
   ...
   --allowedDocTypes=quick-suggest,fx-suggest,top-sites,topsites-click,topsites-impression,quicksuggest-impression,quicksuggest-click \
   --allowedNamespaces=firefox-desktop,firefox-ios,fenix,contextual-services,org-mozilla-fenix,org-mozilla-firefox-beta,org-mozilla-firefox,org-mozilla-ios-firefox,org-mozilla-ios-firefoxbeta,org-mozilla-ios-fennec \
