...
public class VerifyMetadataTest {
  ...
  public void testRejectUncompressed() {
    ...
    final List<PubsubMessage> input = Arrays.asList(
        new PubsubMessage(decoder.decode("dGVzdA=="), attributes),
        new PubsubMessage(decoder.decode("H4sIAM1ekFsAAytJLS4BAAx+f9gEAAAA"), attributes));
  ...
  public void testRejectUserAgent() {
    ...
    final List<PubsubMessage> input = Collections.singletonList(
        new PubsubMessage(decoder.decode("H4sIAM1ekFsAAytJLS4BAAx+f9gEAAAA"), attributes));
  ...
  public void testRejectFirefoxVersion() {
    ...
    final List<PubsubMessage> input = Streams
        ...
        .map(attributes -> new PubsubMessage(decoder.decode("H4sIAM1ekFsAAytJLS4BAAx+f9gEAAAA"),
            attributes))
