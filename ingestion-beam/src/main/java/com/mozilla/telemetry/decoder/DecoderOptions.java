...
public interface DecoderOptions extends SinkOptions, PipelineOptions {
  ...
  @Description("If set to true, enable ingestion of messages published directly to Pub/Sub"
      + " with ping metadata set as message attributes. Pub/Sub publishTime will be used as"
      + " submission_timestamp. See com.mozilla.telemetry.decoder.StampSubmissionTimestamp.")
  @Default.Boolean(false)
