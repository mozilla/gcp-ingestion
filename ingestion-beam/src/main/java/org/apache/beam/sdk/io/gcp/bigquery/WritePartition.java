...
class WritePartition<DestinationT>
  ...
  static final Logger LOG = LoggerFactory.getLogger(WritePartition.class);
  ...
  public void processElement(ProcessContext c) throws Exception {
    ...
    // TODO: Remove this Mozilla patch when this parameter becomes user-configurable:
    // https://jira.apache.org/jira/browse/BEAM-8745
    long modifiedMaxSizeBytes = 100 * (1L << 30);
    ...
    for (WriteBundlesToFiles.Result<DestinationT> fileResult : results) {
      ...
      DestinationData destinationData =
          currentResults.computeIfAbsent(
              destination, k -> DestinationData.create(maxNumFiles, modifiedMaxSizeBytes));
      ...
      if (!latestPartition.canAccept(1, fileResult.fileByteSize)) {
        ...
        latestPartition = PartitionData.withMaximums(maxNumFiles, modifiedMaxSizeBytes);
